...
public class JapaneseCharacter {
    ...
    public static String fromRomajiToHiragana(String s, int trigger) {
        int idx = java.util.Arrays.asList(romaji).indexOf(s);
        return Character.toString((char)(idx + 0x3041 + trigger));
    }

    public static String fromRomajiToFullWidthKatakana(String s, int trigger) {
        int idx = java.util.Arrays.asList(romaji).indexOf(s);
        return Character.toString((char)(idx + 0x3041 + 0x60 + trigger));
    }
    ...
    public static int getRomajiIndex(char c) {
        return c - 0x3041;
    }
